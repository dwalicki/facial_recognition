...
import ShortParagraphIMG from '../../assets/images/short-paragraph.png';
...
class Billing extends React.Component {
    ...
    handleUnsubscribe = () => {
        ...
        authAxios.post(cancelSubscriptionURL).then(res => {
            this.setState({
                loading: false
            });
            this.close();
